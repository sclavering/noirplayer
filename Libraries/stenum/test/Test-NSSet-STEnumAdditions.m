...
#import "Test-NSSet-STEnumAdditions.h"
...
@implementation Test_NSSet_STEnumAdditions
-(void)setUp{
...
-(void)testSelect{
    id tempSet = [NSSet setWithObjects:@"-5",@"-3",nil];
    id tempSet2 = [testSet selectUsingFunction:Test_ST_selectNegativeNumbers context:NULL];
    STAssertEqualObjects(tempSet,tempSet2,[NSString stringWithFormat:@"test Set %@",tempSet2,nil]);
}

-(void)testSelectInline{
    id tempSet = [NSSet setWithObjects:@"-5",@"-3",nil];
    

    
    id tempSet2 = [tempSet selectUsingFunction:selectNegative context:NULL];
    STAssertEqualObjects(tempSet,tempSet2,[NSString stringWithFormat:@"test Set %@",tempSet2,nil]);
}
